...
class RadiationService(ServiceBase):
    """
    ...
    def get_max_cps(self) -> int:
        ...
        def op() -> int:
            ...
            return self._manager.read_u32_be()
        return self._call("get_max_cps", op)
    ...
    def get_cpm_high_tube(self) -> int:
        ...
        def op() -> int:
            ...
            return self._manager.read_u32_be()
        return self._call("get_cpm_high_tube", op)
    ...
    def get_cpm_low_tube(self) -> int:
        ...
        def op() -> int:
            ...
            return self._manager.read_u32_be()
        return self._call("get_cpm_low_tube", op)